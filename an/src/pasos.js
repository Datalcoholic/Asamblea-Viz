const textSteps = [
  {
    step:
      "De acuerdo a los resultados de las elecciones parlamentarias del 2015 la <br/><strong>Asamblea Nacional</strong> quedo compuesta de la siguiente manera:<br/> - <spam class='oposicion'> Oposicion 112 diputados </spam><br/> - <spam class='gpp'>GPP 55 diputados</spam><br/><strong>¿Cual es la situacion de cada bancada a la fecha de hoy?</strong>"
  },
  {
    step:
      "Comenzando con la bancada de <spam class='oposicion'> Oposicion</spam>. El <spam class='gpp'>TSJ</spam> ordena la desincorporacion de los diputados electos por el estado <strong>Amazonas</strong> INSERTAR NOMBRES. Dejando estos <strong>3</strong> curules <spam class='vacios'>vacios</spam>"
  },
  {
    step:
